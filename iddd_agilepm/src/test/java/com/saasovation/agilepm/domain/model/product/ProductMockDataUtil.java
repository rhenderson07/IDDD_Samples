...
public class ProductMockDataUtil {

    //private TaskId taskId;

    public BacklogItem backlogItemForTest(Product aProduct) {
        return this.backlogItem1ForTest(aProduct);
    }

    public BacklogItem backlogItem1ForTest(Product aProduct) {
    ...
    public BacklogItem backlogItem2ForTest(Product aProduct) {
        BacklogItem backlogItem =
                aProduct.planBacklogItem(
    ...
    public BacklogItem backlogItem3ForTest(Product aProduct) {
        BacklogItem backlogItem =
                aProduct.planBacklogItem(
    ...
    public Release releaseForTest(Product aProduct) {
        Date now = new Date();
    ...
    public Sprint sprintForTest(Product aProduct) {
        Date now = new Date();
...
//    public Task taskForTest(BacklogItem aBacklogItem, int anOption) {
...
//    }
    ...
    public String taskDescriptionOfOption(int anOption) {
    ...
    public int taskHoursRemainingOfOption(int anOption) {
    ...
    public String taskNameOfOption(int anOption) {
        String[] taskNames =
                new String[] {
                    "Task 1",
                    "Task 2",
    ...
    public TeamMember teamMemberOfOption(int anOption) {
    ...
    public TeamMember teamMemberForTest() {
        return this.teamMemberForTest1();
    }

    public TeamMember teamMemberForTest1() {
    ...
    public TeamMember teamMemberForTest2() {
        TeamMember teamMember =
                new TeamMember(
                        new TenantId("T12345"),
                        "zoe",
    ...
    public TeamMember teamMemberForTest3() {
        TeamMember teamMember =
                new TeamMember(
                        new TenantId("T12345"),
                        "jdoe",
